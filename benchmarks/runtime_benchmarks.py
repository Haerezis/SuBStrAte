...
#This script call gcc on every source code generated by plot from the original and
#substrate optimized scops, and then run the binary, recording the time they took
#to run.
#
#We then compare the runtime of the original and substrate optimized scops, to see
#if there is a speedup.
...
#Generate binary and benchmark the runtime of a source code.
...
#Generate gnuplot data file from the runtime benchmark results.
